 ...
 */
public class FilterRow extends RecyclerView {
    ...
    public FilterRow(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FilterRow(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public void show(List<String> data) {
        ...
        if (mAdapter == null) {
            ...
            LinearLayoutManager mLayoutManager = new LinearLayoutManager(mCtx, LinearLayoutManager.VERTICAL, false);
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            item.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,100));
